...
export default function TodayScreen() {
  ...
  async function handleChat() {
    ...
    try {
      ...
      Alert.alert("Error", "Could not reach Hearth.");
    } finally {
...
const styles = StyleSheet.create({
  ...
  date:        { fontSize:14, color:"#A0856B", marginTop:2, marginBottom:20 },
  section:     { fontSize:11, fontWeight:"700", color:"#A0856B",
                 letterSpacing:1.5, marginTop:16, marginBottom:10 },
  emptyCard:   { backgroundColor:"#F0FFF4", borderRadius:12, padding:16,
                 alignItems:"center" },
  ...
  dismiss:     { color:"#A0856B", fontSize:12, marginTop:8,
                 alignSelf:"flex-end" },
  chatRow:     { flexDirection:"row", gap:8, marginTop:8 },
  input:       { flex:1, backgroundColor:"#fff", borderRadius:12,
                 padding:14, fontSize:14, color:"#5C4033",
                 borderWidth:1, borderColor:"#F5E6D3" },
  sendBtn:     { backgroundColor:"#E8734A", borderRadius:12,
